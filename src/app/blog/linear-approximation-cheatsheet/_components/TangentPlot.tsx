...
export function TangentPlot({ labels }: { labels: Labels }) {
    ...
    <div className="not-prose mt-6 rounded-2xl border border-zinc-200 bg-zinc-50 p-4 sm:p-5 dark:border-zinc-800 dark:bg-zinc-900/60">
      <div className="rounded-xl bg-white dark:bg-zinc-950/50">
        <svg
          ...
          role="img"
          aria-label="A curve and its tangent line, marking the value at the reference point and both the true and approximated values one step away"
        >
          <rect
